...
public class RemoveItemActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    // TODO: 5/12/2023 Remove items 
    // TODO: 5/12/2023 make logout everywhere
    ...
    private void confirmDeletion() {
        ...
        alertBuilder.setMessage("Are you sere you want to delete:\n\n" + item.getItemName() + "  x " + item.getItemsInStock() + "  $" + item.getPrice());
        ...
        alertBuilder.setPositiveButton(getString(R.string.yes),
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Toast.makeText(getApplicationContext(), item.getItemName() + " has been successfully removed", Toast.LENGTH_SHORT).show();
                        item = null;
                        refreshDisplay();
                    }
                });
    ...
    private void createDropdown() {
        inventory = findViewById(R.id.listOfItems);
